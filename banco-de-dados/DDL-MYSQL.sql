...
CREATE TABLE `TB_PF_PESSOA_FISICA` (
...
CREATE TABLE `TB_PJ_PESSOA_JURIDICA` (
  `ID_PESSOA_JURIDICA` INT NOT NULL,
  `NM_RAZAO_SOCIAL` VARCHAR(100),
  `NM_EMPRESARIAL` VARCHAR(100),
  `NR_CNPJ` VARCHAR(14),
...
CREATE TABLE `TB_ADVOGADO` (
  ...
  CONSTRAINT `FK_PF_ADV_ID_PESSOA_FISICA` FOREIGN KEY (`ID_PESSOA_FISICA`) REFERENCES `TB_PF_PESSOA_FISICA` (`ID_PESSOA_FISICA`),
  CONSTRAINT `FK_PJ_ADV_ID_PESSOA_JURIDICA` FOREIGN KEY (`ID_PESSOA_JURIDICA`) REFERENCES `TB_PJ_PESSOA_JURIDICA` (`ID_PESSOA_JURIDICA`),
...
CREATE TABLE `TB_CLIENTE` (
  ...
  CONSTRAINT `FK_PF_CLI_ID_PESSOA_FISICA` FOREIGN KEY (`ID_PESSOA_FISICA`) REFERENCES `TB_PF_PESSOA_FISICA` (`ID_PESSOA_FISICA`),
  CONSTRAINT `FK_PJ_CLI_ID_PESSOA_JURIDICA` FOREIGN KEY (`ID_PESSOA_JURIDICA`) REFERENCES `TB_PJ_PESSOA_JURIDICA` (`ID_PESSOA_JURIDICA`),
